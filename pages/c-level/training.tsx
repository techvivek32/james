...
const CLevelTrainingPage: NextPage = () => {
  ...
  return (
    <CLevelLayout currentView="training">
      {/* companyWide → C-Level can assign playlists / unlock lessons for ANY rep,
...
export default CLevelTrainingPage;
